...
<div class="header pb-8 pt-5 pt-md-8"
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6">
                <h1 class="text-white">
                    {{ __('Master Data member') }}
                </h1>
            </div>
            {{-- <div class="col-lg-6 text-right">
                <a id='new-member' href='#' title='Add new user'
                    class="ml-2 icon icon-shape bg-warning text-white rounded-circle shadow">
                    <i class="fas fa-plus"></i>
                </a>
                <a href='{{ route('export.member') }}' title='Export user from excel'
            ...
            <a href='{{ route('pdf.member') }}' title='Print data user'
        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="card-body px-0 table-responsive">
                    <table class="table align-items-center table-flush" id="members-table">
