...
">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                <li class="nav-item {{ Request::is('dashboard') ? 'active' : '' }}">
                    <a class="nav-link {{ Request::is('dashboard') ? 'active' : '' }} "
                        href=" {{ route('dashboard') }}"> <i class="ni ni-tv-2 text-primary"></i>
                        {{ __('Dashboard') }}
                    </a>
                </li>
                <li class="nav-item {{ Request::is('master') ? 'active' : '' }}">
                    <a class="nav-link {{ Request::is('master') ? 'active' : '' }}" href=" {{ route('master.index') }}">
                        <i class="ni ni-single-02 text-primary"></i>
                        {{ __('Master') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class=" nav-link" href=" #"> <i class="ni ni-archive-2 text-primary"></i>
                        {{ __('Catalog') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class=" nav-link" href=" #"> <i class="ni ni-user-run text-primary"></i>
                        {{ __('Guest') }}
                    </a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav mb-md-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-building text-info"></i>{{ __('Vendor') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
